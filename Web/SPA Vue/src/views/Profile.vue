    ...
    <v-row class="d-flex justify-center">
      <v-col cols="12" md="6">
        <v-card class="d-flex flex-column align-center pt-4 opacity">
          ...
          <v-card-title class="text-sm-h4">{{
            getFullName(getLoggedUser)
          }}</v-card-title>
          ...
          <upload-file v-if="false" @image-uploaded="setAvatar"
            >Change avatar</upload-file
          >
        </v-card>
      </v-col>
    </v-row>
